  ...
  const projects: Project[] = [
    {
      ...
      technologies: ["ReactJS", "SpringSec", "SpringBoot", "PostgreSQL"],
      liveUrl: "#",
    ...
    },
    {
      ...
      category: "Web Development",
      technologies: ["SpringBoot", "SpringSec", "NextJS", "JWT"],
      liveUrl: "#",
    ...
    },
    {
      ...
      technologies: ["Python", "React", "PenText", "ThreeJS"],
      liveUrl: "#",
    ...
    },
    {
      ...
      technologies: ["Python", "Pygame", "Blender"],
      liveUrl: "#",
